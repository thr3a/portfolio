...
while true; do
    ...
    data=$(printf '{"query":"","searchTargets":{"stores":{"pagination":{"page":%d,"size":100},"filters":{"giftVouchers":{"enabled":true,"allConfigIds":["1f071d26-1083-64df-bf93-b226f447cf8b"],"configIds":["1f071d26-1083-64df-bf93-b226f447cf8b"]},"categories":null},"sortBy":"POPULARITY","additionalFieldsToInclude":["ADDRESS","WORKING_HOURS"]}}}' "$page")

    echo "ページ ${page} のデータを取得中..."

    # curlコマンドを実行し、HTTPレスポンスを変数に格納する。-sは進捗非表示、-Sはエラー時のみ表示
    response=$(curl -sS -X POST 'https://www.paypay.ne.jp/portal2/proxy/paypay-search/v1/gv/search' \
        -H 'Accept: application/json, text/plain, */*' \
        -H 'baggage: sentry-environment=Production,sentry-release=5.11.0,sentry-public_key=a0b12e9a956df1683da7fae385327469,sentry-trace_id=b34db6c6bb7442c6bdbdf93e4fad0c83' \
        -H 'paypayLang: ja' \
        -H 'Accept-Language: ja' \
        --compressed \
        -H 'sentry-trace: b34db6c6bb7442c6bdbdf93e4fad0c83-a32ec3cc46e9ab99' \
